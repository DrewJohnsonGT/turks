          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                ...
                id="message"
                rows={4}
                className="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-main-600 sm:text-sm sm:leading-6"></textarea>
            </div>
          </div>
        </div>
        <div className="mt-10">
